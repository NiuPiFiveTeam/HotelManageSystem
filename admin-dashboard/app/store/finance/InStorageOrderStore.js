Ext.define('Admin.store.finance.InStorageOrderStore', {
    extend: 'Ext.data.Store',

    storeId:'inStorageOrderStore',
    alias: 'store.inStorageOrderStore',
    ...
    proxy: {
        // type:'memory', 
        type: 'ajax',
        url: '/inStorage/findCompleteInStorage', //mvc url  xxx.json
