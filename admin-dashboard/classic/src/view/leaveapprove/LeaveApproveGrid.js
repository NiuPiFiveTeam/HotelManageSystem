Ext.define('Admin.view.leaveapprove.LeaveApproveGrid', {
	...
	columns: [{
		...
		,{header: '开始时间' ,dataIndex: 'startTime',width: 100,sortable: true,renderer: Ext.util.Format.dateRenderer('Y/m/d H:i:s')}
		,{header: '结束时间' ,dataIndex: 'endTime',width: 100,sortable: true,renderer: Ext.util.Format.dateRenderer('Y/m/d H:i:s')}
		,{header: '理由' 		,dataIndex: 'reason',width: 80,sortable: true}
		,{header: '类型'  	,dataIndex: 'leaveType',width: 80,sortable: true,
            renderer: function(val) {
	            if (val =='A') {
