        ...
        '<div class="huangxinjian" >',
            ...
            '<div class="bars">',
                '<div class="bar-group" style="margin-left: 0.8%;">',
                    '<div class="bar bar-1 stat-1" id="firstFloorNumber"  style="height: 1%;">',
                    '<span>4080</span>',
                    '</div>',
                    '<div class="bar bar-2 stat-2" id="firstFloorCINumber" style="height: 1%;">',
                    '<span>5680</span>',
                    '</div>',
                '</div>',
                '<div class="bar-group" style="margin-left: 0.8%;">',
                    '<div class="bar bar-4 stat-1" id="secondFloorNumber"  style="height: 1%;">',
                    '<span>6080</span>',
                    '</div>',
                    '<div class="bar bar-5 stat-2" id="secondFloorCINumber"  style="height: 1%;">',
                    '<span>6880</span>',
                    '</div>',
                '</div>',
                '<div class="bar-group" style="margin-left: 1.8%;">',
                    '<div class="bar bar-7 stat-1" id="thirdFloorNumber" style="height: 1%;">',
                    '<span>6240</span>',
                    '</div>',
                    '<div class="bar bar-8 stat-2" id="thirdFloorCINumber" style="height: 1%;">',
                    '<span>5760</span>',
                    '</div>',
                '</div>',
                '<div class="bar-group" style="margin-left: 1.5%;">',
                    '<div class="bar bar-10 stat-1" id="fourFloorNumber" style="height: 1%;">',
                    '<span>3520</span>',
                    '</div>',
                    '<div class="bar bar-11 stat-2" id="fourFloorCINumber" style="height: 1%;">',
                    '<span>5120</span>',
                    '</div>',
                '</div>',
                '<div class="bar-group" style="margin-left: 1.5%;">',
                    '<div class="bar bar-13 stat-1" id="fiveFloorNumber" style="height: 1%;">',
                    '<span>2240</span>',
                    '</div>',
                    '<div class="bar bar-14 stat-2" id="fiveFloorCINumber" style="height: 1%;">',
                    '   <span>2640</span>',
                    '</div>',
                '</div>',
                '<div class="bar-group" style="margin-left: 1.5%">',
                    '<div class="bar bar-3 stat-1" id="sixFloorNumber" style="height: 1%;">',
                    '<span>6240</span>',
                    '</div>',
                    '<div class="bar bar-9 stat-2" id="sixFloorCINumber" style="height: 1%;">',
                    '<span>5760</span>',
                    '</div>',
                '</div>',
            '</div>',
