Ext.define('Admin.view.process.definition.ProcessDefinitionGridPanel', {
    ...
    items: [{
            ...
            columns : [
				 {header : '流程定义实体Id',dataIndex : 'id',flex:1,align:'center', width : 120,sortable : true}
				,{header : '类别',dataIndex : 'category',flex:1,align:'center',width : 200,sortable : true}
				,{header : '名称',dataIndex : 'name',flex:1,align:'center',width : 100,sortable : true}
				,{header : '流程key',dataIndex : 'key',flex:1,align:'center',width : 80,sortable : true}
				,{header : '版本号',dataIndex : 'version',flex:1,align:'center',width : 60,sortable : true}
				,{header : '部署Id',dataIndex : 'deploymentId',align:'center',flex:1,width : 60,sortable : true,hidden : true}
				//,{header : '部署时间',dataIndex : 'deploymentTime',width : 150,sortable : true,
				//	renderer : Ext.util.Format.dateRenderer('Y/m/d H:i:s')}
				,{header : 'bpmn XML',dataIndex : 'resourceName',flex:1,align:'center',width : 120,sortable : true,
				...
				,{header : '流程图',dataIndex : 'diagramResourceName',flex:1,align:'center',width : 120,sortable : true,
					renderer : function(value, metaData, record, rowIdx, colIdx,store, view) {
						return '<a target="_blank" href="'
								+ 'process-definition/resource?pdid='
								+ record.get('id') + '&resourceName='
				...
				,{header : '是否挂起',dataIndex : 'suspended',flex:1,align:'center',width : 80,	sortable : true}
				...
				,{xtype : 'actioncolumn',cls : 'content-column',align:'center',width : 260,text : '操作',
					items : [{
