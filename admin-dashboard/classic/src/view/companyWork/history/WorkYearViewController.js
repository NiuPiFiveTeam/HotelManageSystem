Ext.define('Admin.view.company.history.WorkYearViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.workYearViewController',

   	onEditButton:function(grid, rowIndex, colIndex){

        var win = this.lookupReference('EditWorkYearWindow');
      if (!win) {
        win = new Admin.view.companyWork.Month.EditWorkPanel;
        this.getView().add(win);
      }
      win.show();
      var form = this.lookupReference('editWorkyearForm').getForm();
