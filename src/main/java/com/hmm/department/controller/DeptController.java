...
public class DeptController {
	...
	@PostMapping
	public ExtAjaxResponse savedept(@RequestBody DeptDTO deptdto) {
		try {
	...
	public ExtAjaxResponse updateDept(@PathVariable("dept_id") Integer dept_id , @RequestBody DeptDTO deptdto) {
		try {
	...
	public ExtAjaxResponse delete(@PathVariable(name="dept_id") Integer dept_id) {
		try {
			if(null != dept_id) {
	...
	public @ResponseBody List<DeptDTOCombox> findCombox(){
