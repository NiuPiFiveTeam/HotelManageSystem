...
public class GuestController {
	...
	public @ResponseBody ExtAjaxResponse uploadPhoto(@RequestParam(value = "file", required = true) MultipartFile file,HttpServletRequest request) throws IOException {
		
		 String webappPath = request.getSession().getServletContext().getRealPath("/");
		 String savePath = webappPath+"resources\\images\\upload";//保存路径
	...
	public String saveGuest(@RequestParam("guestList") String[] guestList) {
		...
		while(index < guestList.length) {
			...
			if (guest == null) {  //说明这个身份证是新用户
				...
				newGuest.setState(GuestState.CASUAL); //临时客人
