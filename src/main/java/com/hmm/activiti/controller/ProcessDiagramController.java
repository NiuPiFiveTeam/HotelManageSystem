...
import com.hmm.activiti.util.CustomProcessDiagramGenerator;
...
public class ProcessDiagramController {
    ...
    //因为pvm包没了，所以就不能再使用ActivityImpl 等相关类了。只能改成用org.activiti.bpmn.model包下的FlowNode类来替代。
	//好在他们差不多，所以代码改动也不大。下面是完整代码：
