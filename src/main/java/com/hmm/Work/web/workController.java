...
public class workController {
	...
	public @ResponseBody ExtAjaxResponse updateWork(HttpSession httpSession) {
		String userId = SessionUtil.getUserName(httpSession);
...
//			Integer totalnormal = workServiceImpl.findByEmployAndOntudytimenormal(userName);
	...
	public ExtTotalworkForm findtotalperson() {
		  ...
		  int tatalPersonNomal = workServiceImpl.findTatalPersonNomal();//补卡
...
//			St 
	...
	public List<Workchart>  findWorkcahrt(@RequestParam("year") Integer year){
		try {
